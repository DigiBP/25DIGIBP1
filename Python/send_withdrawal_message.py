...
TOPIC = "send_withdrawal_message"
WORKER_ID = "python-worker-14"



def send_email(data: dict, business_key):
    """
    Compose and send an HTML-formatted email to inform the user that their feedback
    has been closed due to a lack of response to a clarification request.
    ...
    message_before_conv = (
        ...
        f"falls Sie das Thema nochmal aufgreifen möchten oder ein anderes Anl\n\n"
        f"Ihr Feedback:"
    )
